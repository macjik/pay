...
const HomePage = () => {
  ...
  const handleCheckout = async () => {
    ...
    const receipt = {
      ...
      Items: [
        //товарные позиции
        {
          ...
          PurveyorData: {
            ...
            Phone: '+998977217600', // телефон поставщика, тег ОД 1171
            Name: 'Firuza Ikram', // наименование поставщика, тег ОФД 1225
            Inn: process.env.REACT_APP_INN, // ИНН поставщика, тег ОФД 1226
          },
        },
      ],
      ...
      email: 'email@email.com', //e-mail покупателя, если нужно отправить письмо с чеком
